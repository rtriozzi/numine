...
void make_tree_NoSysts_copy(std::string outname = "CNAF_NuE_1eNp0pi_NuMI_var12_NoCut.root")
{
  ...
  SpectrumLoader mc("/storage/gpfs_data/icarus/plain/data/mc/mc-v10_06_00_01p01-202603-cnaf-numi-nue-disap_variations/nue_var12_null/run*/nuedis_cafmakerjob*/*.flat.caf.root"); // CV
