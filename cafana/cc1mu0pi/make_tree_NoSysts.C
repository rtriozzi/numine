...
void make_tree_NoSysts(std::string outname = "CNAF_CV_1muNp0pi_NuMI_var2_NoCut.root")
{
  ...
  SpectrumLoader mc("/storage/gpfs_data/icarus/plain/data/mc/mc-v10_06_00_01p01-202603-cnaf-numi-nue-disap_variations/var2_hiintnoise/run*/nuedis_cafmakerjob*/*.flat.caf.root");
