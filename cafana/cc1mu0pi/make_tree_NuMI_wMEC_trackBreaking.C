...
void make_tree_NuMI_wMEC_trackBreaking(std::string outname = "CNAF_CV_1muNp0pi_NuMI_wMEC_trackBreaking.root")
{
  // FNAL
  ...
  std::vector<std::string> nu_branch_names = {
    ...
    "recoE_cathode", "endX_cathode",
    "recoE_zeqzero", "endZ_zeqzero",
    "nprotons",
    "leadpmom", "sleadpmom",
    "pchi2mu", "pchi2pr",
    "ptrkscore",
  ...
  std::vector<Var> nu_vars = {
    ...
    kRecoNeutrino_NuMuCC0piEnergy_BrokenAtCathode, kMuon_EndX_BrokenAtCathode,
    kRecoNeutrino_NuMuCC0piEnergy_BrokenAtZ0, kMuon_EndZ_BrokenAtZ0,
    kNSelectedProtons_N,
